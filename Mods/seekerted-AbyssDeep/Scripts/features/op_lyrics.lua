...
local function WBP_Movie_C__OpenMovie(Param_WBP_Movie_C, Param_NewParam)
	...
	DisplaySubs(Subs, 26, 40, "We began to move silently")
	DisplaySubs(Subs, 29, 82, "Our hearts were beating faster today")
	DisplaySubs(Subs, 33, 32, "Than it did yesterday")
	DisplaySubs(Subs, 37, 32, "All right now, take my hand")
	DisplaySubs(Subs, 40, 80, "And leave all your hesitations behind")
	DisplaySubs(Subs, 43, 41, "We'll head to the direction the compass points to")
	DisplaySubs(Subs, 49, 41, "Towards the very end of the Abyss")
	DisplaySubs(Subs, 53, 97, "As if lured by the darkness within")
	DisplaySubs(Subs, 57, 63, "And if it will change everything,")
	DisplaySubs(Subs, 61, 28, "I don't mind that")
	...
	DisplaySubs(Subs, 77, 75, "In this journey with no return")
